...
- **`uv pip install`**: Installs a package into the virtual environment.
- **`uv pip uninstall`**: Uninstalls a package from the virtual environment.
- **`uv pip list`**: Lists the installed packages in the virtual environment.
